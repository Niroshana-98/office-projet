...
<body id="body-pd">
    ...
    <header class="loginDetails">
        ...
        <div class="login-detail">
            ...
            <span class="value" id="user-position">Chief Secretary </span>
        </div>
        <div class="login-detail">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                <a href="./CSec.php" class="nav_logo">
    ...
    <div class="height-100 bg-light" style="width: 100%; height: 100vh; overflow: hidden;">
        <iframe name="content-frame" src="./CSecDashboard.php" 
