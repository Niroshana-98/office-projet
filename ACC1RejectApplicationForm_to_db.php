...
$stmt = $conn->prepare("
    SELECT 
        ...
        a.ACC1_time_stamp, u18.name AS acc1_name, u18.desi AS acc1Designation, a.ACC1_Reject_RM 
    FROM 
        application a
    LEFT JOIN 
        service s 
...
$stmt->bind_result(
    ...
    $ACC1_time_stamp, $acc1_name, $acc1Designation, $ACC1_Reject_RM   
);
