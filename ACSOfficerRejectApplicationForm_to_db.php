...
$stmt = $conn->prepare("
    SELECT 
        ...
        a.ACS_time_stamp, u15.name AS acs_name, u15.desi AS acsDesignation, a.ACS_Reject_RM 
    FROM 
        application a
    LEFT JOIN 
        service s 
...
$stmt->bind_result(
    ...
    $ACS_time_stamp, $acs_name, $acsDesignation, $ACS_Reject_RM   
);
