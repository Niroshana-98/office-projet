...
$newAppQuery = "SELECT COUNT(*) AS count FROM application WHERE app_status IN (230, 231)";
...
$rejectedAppQuery = "SELECT COUNT(*) AS count FROM application WHERE app_status IN (221)";
