...
<body id="body-pd">
    ...
    <header class="loginDetails">
        ...
        <div class="login-detail">
            ...
            <span class="value" id="user-position">Department Check Officer</span>
        </div>
        <div class="login-detail">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                <a href="./depCheckOfficer.php" class="nav_logo">
                <i class='bx bx-home'></i>
                    <span class="nav_logo-name">Home</span>
                </a>
                <div class="nav_list">
                    <a href="./depCheckOfficerDashboard.php" class="nav_link active" target="content-frame">
    ...
    <div class="height-100 bg-light" style="width: 100%; height: 100vh; overflow: hidden;">
        <iframe name="content-frame" src="./depCheckOfficerDashboard.php" 
    ...
    <script src="./js/depCheckOfficer.js"></script>
