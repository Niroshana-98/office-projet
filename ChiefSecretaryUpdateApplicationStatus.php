...
if ($status == 2 && !empty($comment)) {
    ...
    if ($offi_cat == 1) {
        $app_status = 2; // Approved status for offi_cat = 1
    } elseif ($offi_cat == 2) {
        $app_status = 110; // Approved status for offi_cat = 2
    }elseif ($offi_cat == 3) {
        $app_status = 110; // Approved status for offi_cat = 3
    } elseif ($offi_cat == 4) {
        $app_status = 110; // Approved status for offi_cat = 4
    }elseif ($offi_cat == 5) {
        $app_status = 110; // Approved status for offi_cat = 5
    }elseif ($offi_cat == 6) {
        $app_status = 110; // Approved status for offi_cat = 6
    }else {
