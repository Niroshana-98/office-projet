...
<body>
    ...
    <div class="tableLayout">
        ...
        <div id ="distOffiHeadDiv">
            <span id="distOffiHeadRecommendation">
        ...
        <div id ="depRecOffiDiv">
            <span id="depOffiRecRecommendation">
        ...
        <div id ="depHeadDiv">
            <span id="depOffiHeadRecommendation">
        ...
        <div id ="CSOffiDiv">
            <span>
                අයදුම්කරු වෙත ප්‍රතිපාදන ලබා දීම අනුමත කරමි
            </span>
    ...
    <script src="./js/CSecApprovedApplicationForm.js"></script>
