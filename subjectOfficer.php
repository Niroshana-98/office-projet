...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                <a href="./subjectOfficer.php" class="nav_logo">
                <i class='bx bx-home'></i>
                    <span class="nav_logo-name">Home</span>
                </a>
                <div class="nav_list">
                    <a href="./subjectOfficerDashboard.php" class="nav_link active" target="content-frame">
    ...
    <script src="./js/subjectOfficer.js"></script>
