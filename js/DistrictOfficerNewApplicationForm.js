document.addEventListener("DOMContentLoaded", function () {
    fetch("DistrictOfficerNewApplicationForm_to_db.php", {
        credentials: 'include'
    })
    ...
    function updateAppStatus(status, comment = '' , nic = '') {
        ...
        fetch('DistrictOfficerUpdateApplicationStatus.php', {
            method: 'POST',
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                window.location.href = 'DistrictOfficerNewApplication.php'; 
            } else {
