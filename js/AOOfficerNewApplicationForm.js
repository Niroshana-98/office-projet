document.addEventListener("DOMContentLoaded", function () {
    fetch("AOOfficerNewApplicationForm_to_db.php")
    ...
    .then(data => {
        if (data.success) { 
            ...
            const csACSOffiDiv = document.getElementById("csACSOffiDiv");
            const csChkOffiHR = document.getElementById("csChkOffiHR");

            if(!data.ACS_Reject_RM) {
                csACSOffiDiv.style.display = "none";
                csChkOffiHR.style.display = "none";
            } else {
    ...
    function updateAppStatus(status, comment = '' , nic = '') {
        ...
        const data = {
            ...
            comment: comment,
            nic: nic,
            AO_Recommend: recommendation  
        };
    
        fetch('AOOfficerUpdateApplicationStatus.php', {
            method: 'POST',
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                window.location.href = 'AOOfficerNewApplication.php'; 
            } else {
