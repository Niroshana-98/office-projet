document.addEventListener("DOMContentLoaded", function () {
    fetch("minHeadOfficerRejectApplicationForm_to_db.php", {
        credentials: 'include'
    })
    ...
    .then(data => {
        if (data.success) {
            ...
            const rejectMinHeadOffiDiv = document.getElementById("rejectMinHeadOffiDiv");

            if(!data.Min_head_Reject_RM) {
                rejectMinHeadOffiDiv.style.display = "none";
            } else {
                document.getElementById("rejectMinHeadOffi").value = data.Min_head_Reject_RM;
