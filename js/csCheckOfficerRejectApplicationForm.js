document.addEventListener("DOMContentLoaded", function () {
    fetch("csCheckOfficerRejectApplicationForm_to_db.php", {
        credentials: 'include'
    })
    ...
    .then(data => {
        if (data.success) {
            ...
            const rejectCSChkOffiDiv = document.getElementById("rejectCSChkOffiDiv");

            if(!data.CS_Chk_Offi_Reject_RM) {
                rejectCSChkOffiDiv.style.display = "none";
            } else {
                document.getElementById("rejectCSChkOffi").value = data.CS_Chk_Offi_Reject_RM;
