document.addEventListener("DOMContentLoaded", function () {
    fetch("minRecOfficerNewApplicationForm_to_db.php")
    ...
    .then(data => {
        if (data.success) {
            ...
            const minHeadOffiDiv = document.getElementById("minHeadOffiDiv");
            const minChkOffiHR = document.getElementById("minChkOffiHR");

            if(!data.Min_head_Reject_RM) {
                minHeadOffiDiv.style.display = "none";
    ...
    function updateAppStatus(status, comment = '' , nic = '') {
        ...
        const data = {
            ...
            comment: comment,
            nic: nic,
            Min_Rec_Offi_Recommend: recommendation  
        };
    
        fetch('minRecOfficerUpdateApplicationStatus.php', {
            method: 'POST',
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                window.location.href = 'minRecOfficerNewApplication.php'; 
            } else {
