document.addEventListener("DOMContentLoaded", function () {
    fetch("ACC2ApprovedApplicationForm_to_db.php", {
        credentials: 'include'
    })
    ...
    .then(data => {
        if (data.success) {
            ...
            const remarkACC2OffiDiv = document.getElementById("remarkACC2OffiDiv");

            if(!data.ACC2_Aprv_RM) {
                remarkACC2OffiDiv.style.display = "none";
            } else {
                document.getElementById("remarkACC2Offi").value = data.ACC2_Aprv_RM;
            }
