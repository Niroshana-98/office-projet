document.addEventListener("DOMContentLoaded", function () {
    fetch("minHeadOfficerNewApplicationForm_to_db.php")
    ...
    .then(data => {
        if (data.success) { 
            ...
            const csChkOffiDiv = document.getElementById("csChkOffiDiv");
            const minRecOffiHR = document.getElementById("minRecOffiHR");

            if(!data.CS_Chk_Offi_Reject_RM) {
                csChkOffiDiv.style.display = "none";
                minRecOffiHR.style.display = "none";
            } else {
    ...
    function updateAppStatus(status, comment = '' , nic = '') {
        ...
        const data = {
            ...
            comment: comment,
            nic: nic,
            Min_head_Recommend: recommendation 
        };
    
        fetch('minHeadOfficerUpdateApplicationStatus.php', {
            method: 'POST',
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                window.location.href = 'minHeadOfficerNewApplication.php'; 
            } else {
