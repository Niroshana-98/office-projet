document.addEventListener("DOMContentLoaded", function () {
    fetch("minCheckOfficerNewApplicationForm_to_db.php")
    ...
    function updateAppStatus(status, comment = '' , nic = '') {
        ...
        fetch('minCheckOfficerUpdateApplicationStatus.php', {
            method: 'POST',
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                window.location.href = 'minCheckOfficerNewApplication.php'; 
            } else {
