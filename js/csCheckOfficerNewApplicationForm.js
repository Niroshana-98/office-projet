document.addEventListener("DOMContentLoaded", function () {
    fetch("csCheckOfficerNewApplicationForm_to_db.php")
    ...
    .then(data => {
        if (data.success) { 
            ...
            const csAOOffiDiv = document.getElementById("csAOOffiDiv");
            const minHeadOffiHR = document.getElementById("minHeadOffiHR");
            if(!data.AO_Reject_RM) {
                csAOOffiDiv.style.display = "none";
                minHeadOffiHR.style.display = "none";
            } else {
    ...
    function updateAppStatus(status, comment = '' , nic = '') {
        ...
        fetch('csCheckOfficerUpdateApplicationStatus.php', {
            method: 'POST',
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                window.location.href = 'csCheckOfficerNewApplication.php'; 
            } else {
