document.addEventListener("DOMContentLoaded", function () {
    fetch("depRecOfficerNewApplicationForm_to_db.php")
    ...
    .then(data => {
        if (data.success) { 
            ...
            if(!data.Dep_head_Reject_RM) {
                depHeadDiv.style.display = "none";
                depChkOffiHR.style.display = "none";
            } else {
                document.getElementById("rejectDepHead").value = data.Dep_head_Reject_RM;
    ...
    function updateAppStatus(status, comment = '' , nic = '') {
        ...
        const data = {
            ...
            comment: comment,
            nic: nic,
            Dep_Rec_Offi_Recommend: recommendation 
        };
    
        fetch('depRecOfficerUpdateApplicationStatus.php', {
            method: 'POST',
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                window.location.href = 'depRecOfficerNewApplication.php'; 
            } else {
