...
<body>
    ...
    <div class="tableLayout">
        ...
        <div id ="minHeadOffiDiv">
            ...
            <div id="rejectMinHeadOffiDiv">
                <div class="table-responsive">
                    <table class="table" id="tableApplicate">
                        <tr>
                            <th scope="row" class="text-left" style="width: 150px;">Remark</th>
                            <td class="text-left"><input type="text" name="rejectkMinHeadOffi" id="rejectMinHeadOffi" disabled></td>
                        </tr>
                    </table> 
                </div>
            </div>
    ...
    <script src="./js/minHeadOfficerRejectApplicationForm.js"></script>
