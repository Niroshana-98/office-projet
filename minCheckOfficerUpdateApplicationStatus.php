...
if ($status == 1) {
    ...
    $stmt = $conn->prepare("UPDATE application SET app_status = ?, Min_Chk_Offi_Aprv_RM = ?, Min_Chk_Offi_time_stamp = NOW(), Min_Chk_Offi_user_id = ?, Min_Rec_Offi_Reject_RM = NULL WHERE app_no = ?");
