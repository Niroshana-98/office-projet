...
$stmt = $conn->prepare("
    SELECT 
        ...
        a.Dep_head_time_stamp , u9.name AS dep_head_name, u9.desi AS depHeadDesignation, a.Dep_head_Reject_RM
    FROM 
        application a
    LEFT JOIN 
        service s 
...
$stmt->bind_result(
    ...
    $Dep_head_time_stamp , $dep_head_name, $depHeadDesignation, $Dep_head_Reject_RM
...
if ($appNo) {
    echo json_encode([
        ...
        'Dep_head_Reject_RM' => $Dep_head_Reject_RM
