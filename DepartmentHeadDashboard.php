...
<body>
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="./DepartmentHeadNewApplication.php" class="btn btn-outline-primary">View New Applications</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="./DepartmentHeadApprovedApplication.php" class="btn btn-outline-success">View Approved Applications</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="./DepartmentHeadRejectApplication.php" class="btn btn-outline-danger">View Rejected Applications</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="./js/DepartmentHeadDashboard.js"></script>
</body>
</html>
