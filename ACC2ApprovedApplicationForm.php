...
<body>
    ...
    <div class="tableLayout">
        ...
        <div id ="minHeadOffiDiv">
            <span>
                උක්ත තොරතුරු සත්‍ය හා නිවැරදි බවත් මීට පෙර පශ්චාත් උපාධි / ඩිප්ලෝමා/පුහුණු පාඨමාලා සඳහා රජය මඟින් ප්‍රතිපාදන ලබා දී ඇති/නොමැති අතර ප්‍රධාන ලේකම් පරිපාලන චක්‍රලේඛ 02/2023 අනුව කටයුතු කිරිමට එකඟ වෙමි.
            </span>

            <div id="remarkMinHeadOffiDiv">
                <div class="table-responsive">
                    <table class="table" id="tableApplicate">
                        <tr>
                            <th scope="row" class="text-left" style="width: 150px;">Remark</th>
                            <td class="text-left"><input type="text" name="remarkMinHeadOffi" id="remarkMinHeadOffi" disabled></td>
                        </tr>
                    </table> 
                </div>
            </div>
            <div class="table-responsive">
                <table class="table" id="tableApplicate">
                    <tr>
                        <th scope="row" class="text-left">Name</th>
                        <td class="text-left" colspan="3"><input type="text" name="minHeadName" id="minHeadName" disabled></td>
                        <th scope="row" class="text-left">Designation</th>
                        <td class="text-left" colspan="3"><input type="text" name="minHeadDesi" id="minHeadDesi" disabled></td>
                        <th scope="row" class="text-left">Date</th>
                        <td class="text-left" colspan="3"><input type="text" name="minHeadDate" id="minHeadDate" disabled></td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div id ="csChkOffiDiv">
            ...
            <div id="remarkCSChkOffiDiv">
                <div class="table-responsive">
                    <table class="table" id="tableApplicate">
                        <tr>
                            <th scope="row" class="text-left" style="width: 150px;">Remark</th>
                            <td class="text-left"><input type="text" name="remarkCSChkOffi" id="remarkCSChkOffi" disabled></td>
                        </tr>
                    </table> 
                </div>
            </div>
            <div class="table-responsive">
                <table class="table" id="tableApplicate">
                    <tr>
                        <th scope="row" class="text-left">Name</th>
                        <td class="text-left" colspan="3"><input type="text" name="CSChkName" id="CSChkName" disabled></td>
                        <th scope="row" class="text-left">Designation</th>
                        <td class="text-left" colspan="3"><input type="text" name="CSChkDesi" id="CSChkDesi" disabled></td>
                        <th scope="row" class="text-left">Date</th>
                        <td class="text-left" colspan="3"><input type="text" name="CSChkDate" id="CSChkDate" disabled></td>
                    </tr>
                </table>
            </div>
        </div> 
        ...
        <div id ="csAOOffiDiv">
            ...
            <div id="remarkAOOffiDiv">
                <div class="table-responsive">
                    <table class="table" id="tableApplicate">
                        <tr>
                            <th scope="row" class="text-left" style="width: 150px;">Remark</th>
                            <td class="text-left"><input type="text" name="remarkAOOffi" id="remarkAOOffi" disabled></td>
                        </tr>
                    </table> 
                </div>
            </div>
        ...
        <div id ="CSOffiDiv">
            ...
            <div id="remarkCSOffiDiv">
                <div class="table-responsive">
                    <table class="table" id="tableApplicate">
                        <tr>
                            <th scope="row" class="text-left" style="width: 150px;">Remark</th>
                            <td class="text-left"><input type="text" name="remarkCSOffi" id="remarkCSOffi" disabled></td>
                        </tr>
                    </table> 
                </div>
            </div>
        ...
        <div id ="ACC1OffiDiv">
            ...
            <div id="remarkACC1OffiDiv">
                <div class="table-responsive">
                    <table class="table" id="tableApplicate">
                        <tr>
                            <th scope="row" class="text-left" style="width: 150px;">Remark</th>
                            <td class="text-left"><input type="text" name="remarkACC1Offi" id="remarkACC1Offi" disabled></td>
                        </tr>
                    </table> 
                </div>
            </div>
        ...
        <div id ="ACC2OffiDiv">
            ...
            <div id="remarkACC2OffiDiv">
                <div class="table-responsive">
                    <table class="table" id="tableApplicate">
                        <tr>
                            <th scope="row" class="text-left" style="width: 150px;">Remark</th>
                            <td class="text-left"><input type="text" name="remarkACC2Offi" id="remarkACC2Offi" disabled></td>
                        </tr>
                    </table> 
                </div> 
            </div>
            <div class="table-responsive">
                <table class="table" id="tableApplicate">
                    <tr>
                        <th scope="row" class="text-left">Name</th>
                        <td class="text-left" colspan="3"><input type="text" name="ACC2Name" id="ACC2Name" disabled></td>
                        <th scope="row" class="text-left">Designation</th>
                        <td class="text-left" colspan="3"><input type="text" name="ACC2Desi" id="ACC2Desi" disabled></td>
                        <th scope="row" class="text-left">Date</th>
                        <td class="text-left" colspan="3"><input type="text" name="ACC2Date" id="ACC2Date" disabled></td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <script src="./js/ACC2ApprovedApplicationForm.js"></script>
