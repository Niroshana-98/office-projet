...
$newAppQuery = "SELECT COUNT(*) AS count FROM application WHERE app_status IN (100, 101)";
...
$rejectedAppQuery = "SELECT COUNT(*) AS count FROM application WHERE app_status IN (119)";
