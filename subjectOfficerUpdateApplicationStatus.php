...
$stmt = $conn->prepare("UPDATE application SET app_status = ?, Subject_Aprv_RM = ?, Subject_time_stamp = NOW(), Subject_user_id = ?, office_Rec_Reject_RM = NULL, Dist_Rec_Offi_Reject_RM = NULL, Dep_Rec_Offi_Reject_RM = NULL, Min_Rec_Offi_Reject_RM = NULL WHERE app_no = ?");
