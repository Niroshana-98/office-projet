...
<body>
    ...
    <div class="tableLayout">
        ...
        <div id ="minRecOffiDiv">
            ...
            <div id="rejectMinRecOffiDiv">
                <div class="table-responsive">
                    <table class="table" id="tableApplicate">
                        <tr>
                            <th scope="row" class="text-left" style="width: 150px;">Remark</th>
                            <td class="text-left"><input type="text" name="rejectMinRecOffi" id="rejectMinRecOffi" disabled></td>
                        </tr>
                    </table> 
                </div>
            </div>
    ...
    <script src="./js/minRecOfficerRejectApplicationForm.js"></script>
