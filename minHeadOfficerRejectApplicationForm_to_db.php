...
$stmt = $conn->prepare("
    SELECT 
        ...
        a.Min_head_time_stamp , u12.name AS min_head_name, u12.desi AS minHeadDesignation, a.Min_head_Reject_RM
    FROM 
        application a
    LEFT JOIN 
        service s 
...
$stmt->bind_result(
    ...
    $Min_head_time_stamp , $min_head_name, $minHeadDesignation, $Min_head_Reject_RM
...
if ($appNo) {
    echo json_encode([
        ...
        'Min_head_Reject_RM' => $Min_head_Reject_RM
