...
<body>
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="./DistrictOfficerNewApplication.php" class="btn btn-outline-primary">View New Applications</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="./DistrictOfficerApprovedApplication.php" class="btn btn-outline-success">View Approved Applications</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="./DistrictOfficerRejectApplication.php" class="btn btn-outline-danger">View Rejected Applications</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="./js/DistrictOfficerDashboard.js"></script>
</body>
</html>
