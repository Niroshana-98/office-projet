...
$stmt = $conn->prepare("
    SELECT 
        ...
        a.CS_Chk_Offi_time_stamp , u13.name AS cs_chk_name, u13.desi AS csChkDesignation, a.CS_Chk_Offi_Reject_RM
    FROM 
        application a
    LEFT JOIN 
        service s 
...
$stmt->bind_result(
    ...
    $CS_Chk_Offi_time_stamp , $cs_chk_name, $csChkDesignation, $CS_Chk_Offi_Reject_RM
...
if ($appNo) {
    echo json_encode([
        ...
        'CS_Chk_Offi_Reject_RM' => $CS_Chk_Offi_Reject_RM
