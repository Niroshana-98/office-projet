...
<body>
    ...
    <div class="tableLayout">
        ...
        <div id ="csChkOffiDiv">
            <span>
                ප්‍ර.ලේ.චක්‍රලේඛ 02/2023 අනුව අයදුම්කරු විසින් සියලු තොරුතුරු ඇතුළත් කර ඇති බවට තහවුරු නොකරමි.
            </span>

            <div id="rejectCSChkOffiDiv">
                <div class="table-responsive">
                    <table class="table" id="tableApplicate">
                        <tr>
                            <th scope="row" class="text-left" style="width: 150px;">Remark</th>
                            <td class="text-left"><input type="text" name="rejectCSChkOffi" id="rejectCSChkOffi" disabled></td>
                        </tr>
                    </table> 
                </div>
            </div>
    ...
    <script src="./js/csCheckOfficerRejectApplicationForm.js"></script>
