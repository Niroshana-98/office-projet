...
$newAppQuery = "SELECT COUNT(*) AS count FROM application WHERE app_status IN (240, 241)";
...
$rejectedAppQuery = "SELECT COUNT(*) AS count FROM application WHERE app_status IN (231)";
