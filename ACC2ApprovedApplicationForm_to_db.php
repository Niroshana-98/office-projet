...
$stmt = $conn->prepare("
    SELECT 
        ...
        a.ACC1_time_stamp, u18.name AS acc1_name, u18.desi AS acc1Designation, a.ACC1_Aprv_RM,
        a.ACC2_time_stamp, u19.name AS acc2_name, u19.desi AS acc2Designation, a.ACC2_Aprv_RM 
    FROM 
        application a
    LEFT JOIN 
        service s 
...
$stmt->bind_result(
    ...
    $ACC1_time_stamp, $acc1_name, $acc1Designation, $ACC1_Aprv_RM,
    $ACC2_time_stamp, $acc2_name, $acc2Designation, $ACC2_Aprv_RM   
);
...
if ($appNo) {
    echo json_encode([
        ...
        'ACC1_time_stamp' => $ACC1_time_stamp,
        'acc1_name' => $acc1_name,
        'acc1Designation' => $acc1Designation,
        'ACC1_Aprv_RM' => $ACC1_Aprv_RM,
        'ACC2_time_stamp' => $ACC2_time_stamp,
        'acc2_name' => $acc2_name,
        'acc2Designation' => $acc2Designation,
        'ACC2_Aprv_RM' => $ACC2_Aprv_RM
    ]); 
} else {
