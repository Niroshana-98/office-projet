...
$newAppQuery = "SELECT COUNT(*) AS count FROM application WHERE app_status IN (250)";
...
$rejectedAppQuery = "SELECT COUNT(*) AS count FROM application WHERE app_status IN (241)";
