...
$stmt = $conn->prepare("
    SELECT 
        ...
        a.Min_Rec_Offi_time_stamp , u11.name AS min_rec_name, u11.desi AS minRecDesignation, a.Min_Rec_Offi_Reject_RM
    FROM 
        application a
    LEFT JOIN 
        service s 
...
$stmt->bind_result(
    ...
    $Min_Rec_Offi_time_stamp , $min_rec_name, $minRecDesignation, $Min_Rec_Offi_Reject_RM   
