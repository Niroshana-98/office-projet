...
$newAppQuery = "SELECT COUNT(*) AS count FROM application WHERE app_status IN (210, 211)";
...
$rejectedAppQuery = "SELECT COUNT(*) AS count FROM application WHERE app_status IN (201)";
