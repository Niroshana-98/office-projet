...
$newAppQuery = "SELECT COUNT(*) AS count FROM application WHERE app_status IN (200, 201)";
...
$rejectedAppQuery = "SELECT COUNT(*) AS count FROM application WHERE app_status IN (101)";
