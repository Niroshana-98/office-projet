...
<body>
    ...
    <div class="tableLayout"> 
        ...
        <div id="rejectByDistChk">
            ...
            <div id="rejectDistChkOfficerDiv">
                <div class="table-responsive">
                    <table class="table" id="tableApplicate">
                        <tr>
                            <th scope="row" class="text-left" style="width: 150px;">Remark</th>
                            <td class="text-left"><input type="text" name="rejectDistChkOfficer" id="rejectDistChkOfficer" disabled></td>
                        </tr>
                    </table> 
                </div>
            </div>
