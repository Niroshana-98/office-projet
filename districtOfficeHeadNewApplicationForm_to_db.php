...
$stmt->bind_result(
    ...
    $Subject_time_stamp, $subject_officer_name, $designation, $Subject_Aprv_Rm, 
    $recommend_officer_name, $recDesignation, $office_Rec_Aprv_RM,  $office_Rec_time_stamp, $office_Rec_Recommend,
