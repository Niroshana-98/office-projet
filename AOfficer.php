...
<body id="body-pd">
    ...
    <header class="loginDetails">
        ...
        <div class="login-detail">
            ...
            <span class="value" id="user-position">AO</span>
        </div>
        <div class="login-detail">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                <a href="./AOfficer.php" class="nav_logo">
                <i class='bx bx-home'></i>
                    <span class="nav_logo-name">Home</span>
                </a>
                <div class="nav_list">
                    <a href="./AOfficerDashboard.php" class="nav_link active" target="content-frame">
    ...
    <div class="height-100 bg-light" style="width: 100%; height: 100vh; overflow: hidden;">
        <iframe name="content-frame" src="./AOfficerDashboard.php" 
    ...
    <script src="./js/AOfficer.js"></script>
