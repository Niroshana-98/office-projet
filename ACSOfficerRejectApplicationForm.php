...
<body>
    ...
    <div class="tableLayout">
        ...
        <div id ="csACSOffiDiv">
            ...
            <div id="rejectACSOffiDiv">
                <div class="table-responsive">
                    <table class="table" id="tableApplicate">
                        <tr>
                            <th scope="row" class="text-left" style="width: 150px;">Remark</th>
                            <td class="text-left"><input type="text" name="rejectACSOffi" id="rejectACSOffi" disabled></td>
                        </tr>
                    </table> 
                </div>
            </div>
    ...
    <script src="./js/ACSOfficerRejectApplicationForm.js"></script>
